...
namespace CatFlap.Core
{
    ...
    /// </summary>
    public class CatFlapRelayFactory
    {
        ...
        /// </summary>
        public CatFlapRelayFactory() : this(NullLoggerFactory.Instance) { }

        public CatFlapRelayFactory(ILoggerFactory loggerFactory)
        {
        ...
        /// </summary>
        public CatFlapRelay CreateRelay(CatFlapRelayOption option)
        {
            ArgumentNullException.ThrowIfNull(option);

            ValidateOption(option);

            var logger = _loggerFactory.CreateLogger<CatFlapRelay>();
            return new CatFlapRelay(option, logger);
        }
        ...
        /// </summary>
        public static void ValidateOption(CatFlapRelayOption option)
        {
            ArgumentNullException.ThrowIfNull(option);
    ...
    {
        private readonly ILoggerFactory _loggerFactory;
        private readonly CatFlapRelayOption _option = new();
        private bool _built;
