...
namespace CatFlap.Core
{
    ...
    /// </summary>
    public class CatFlapRelayManager : IAsyncDisposable
    {
        private readonly ILoggerFactory _loggerFactory;
        private readonly ILogger<CatFlapRelayManager> _logger;
        private readonly ConcurrentDictionary<Guid, CatFlapRelay> _relays = new();
        ...
        /// </summary>
        public CatFlapRelayManager() : this(NullLoggerFactory.Instance) { }

        public CatFlapRelayManager(ILoggerFactory loggerFactory)
        {
            ArgumentNullException.ThrowIfNull(loggerFactory);
            _loggerFactory = loggerFactory;
            _logger = _loggerFactory.CreateLogger<CatFlapRelayManager>();
        }
        ...
        public void AddRelay(CatFlapRelayOption option)
        {
            ObjectDisposedException.ThrowIf(_disposed == 1, this);
            ArgumentNullException.ThrowIfNull(option);
            CatFlapRelayFactory.ValidateOption(option);
            ...
            lock (_managementLock)
            {
                ...
                var relayLogger = _loggerFactory.CreateLogger<CatFlapRelay>();
                relay = new CatFlapRelay(option, relayLogger);
        ...
        public int AddRelays(IEnumerable<CatFlapRelayOption> options)
        {
            ObjectDisposedException.ThrowIf(_disposed == 1, this);
        ...
        /// Gets a relay by id
        /// </summary>
        public bool TryGetRelay(Guid id, out CatFlapRelay? relay)
        {
        ...
        /// Callers may read <see cref="CatFlapRelay.Statistics"/> and
        /// <see cref="CatFlapRelay.Option"/> on each instance freely;
        /// the snapshot list itself will not reflect subsequent Add/Remove operations.
        /// </summary>
        public IReadOnlyList<CatFlapRelay> GetAllRelays() => [.. _relays.Values];
