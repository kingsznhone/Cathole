...
{
    [JsonSerializable(typeof(CatFlapRelayOption))]
    internal partial class CatFlapRelayOptionContext : JsonSerializerContext { }

    public class CatFlapRelayOption
    {
        ...
        public override string ToString() => JsonSerializer.Serialize(this, _jsonContext.CatFlapRelayOption);
    }
}
