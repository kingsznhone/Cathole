...
namespace CatHole.Panel.Controllers;
...
public class RelayController : ControllerBase
{
    ...
    private RelayResponse ToResponse(CatHoleRelayOption o) => new(
        o.Id,
        o.Name,
        o.ListenHost,
        o.TargetHost,
    ...
    private static CatHoleRelayOption ToOption(RelayRequest request, Guid? id = null) => new()
    {
        Id = id ?? Guid.NewGuid(),
        Name = request.Name,
