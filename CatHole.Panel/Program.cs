...
using CatHole.Panel.OpenApiTransformer;
...
namespace CatHole.Panel
{
    public class Program
    {
        ...
        private static void EnsureDataDirectories(WebApplicationBuilder builder)
        {
            ...
            {
                const string inMemoryCs = "Data Source=CatHoleEphemeral;Mode=Memory;Cache=Shared";
                Log.Warning(ex,
            ...
            app.UseSwaggerUI(options =>
            {
                foreach (var description in versionProvider.ApiVersionDescriptions)
                {
                    options.SwaggerEndpoint(
                        ...
                        $"CatHole API {description.GroupName.ToUpperInvariant()}"
                    );
                }
