...
public class RelayController : ControllerBase
{
    ...
    public RelayController(RelayService relayService, LinkGenerator linkGenerator, IOptionsSnapshot<PanelSettings> panelSettings)
    {
    ...
    {
        if (request.BufferSize > _panelSettings.MaxBufferSize)
            return Problem(title: "Invalid buffer size",
                detail: $"BufferSize cannot exceed {_panelSettings.MaxBufferSize} bytes.",
    ...
    private RelayResponse ToResponse(FlapRelayOption o) => new(
        o.Id,
        o.Name,
        o.ListenHost,
        o.TargetHost,
    ...
    private static FlapRelayOption ToOption(RelayRequest request, Guid? id = null) => new()
    {
        Id = id ?? Guid.NewGuid(),
        Name = request.Name,
