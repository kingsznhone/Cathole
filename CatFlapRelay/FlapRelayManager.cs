...
namespace CatFlapRelay
{
    ...
    /// </summary>
    public class FlapRelayManager : IAsyncDisposable
    {
        private readonly ILoggerFactory _loggerFactory;
        private readonly ILogger<FlapRelayManager> _logger;
        private readonly ConcurrentDictionary<Guid, FlapRelay> _relays = new();
        ...
        /// </summary>
        public FlapRelayManager() : this(NullLoggerFactory.Instance) { }

        public FlapRelayManager(ILoggerFactory loggerFactory)
        {
            ArgumentNullException.ThrowIfNull(loggerFactory);
            _loggerFactory = loggerFactory;
            _logger = _loggerFactory.CreateLogger<FlapRelayManager>();
        }
        ...
        public void AddRelay(FlapRelayOption option)
        {
            ...
            lock (_managementLock)
            {
                ...
                var relayLogger = _loggerFactory.CreateLogger<FlapRelay>();
                relay = new FlapRelay(option, relayLogger);
        ...
        public int AddRelays(IEnumerable<FlapRelayOption> options)
        {
            ObjectDisposedException.ThrowIf(_disposed == 1, this);
        ...
        /// Gets a relay by id
        /// </summary>
        public bool TryGetRelay(Guid id, out FlapRelay? relay)
        {
        ...
        /// </summary>
        public IReadOnlyList<FlapRelay> GetAllRelays() => [.. _relays.Values];
