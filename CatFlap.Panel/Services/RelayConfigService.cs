...
public sealed class RelayConfigService
{
    ...
    public async Task<IReadOnlyList<CatFlapRelayOption>> GetAllAsync()
    {
    ...
    public async Task AddAsync(CatFlapRelayOption option)
    {
    ...
    public async Task UpdateAsync(Guid id, CatFlapRelayOption option)
    {
        ArgumentNullException.ThrowIfNull(option);
        await using var db = await _dbFactory.CreateDbContextAsync();
        var entry = await db.Relays.FindAsync(id)
    ...
    private static CatFlapRelayOption ToOption(RelayEntry e) => new()
    {
        Id = e.Id,
        Name = e.Name,
    ...
    private static RelayEntry ToEntry(CatFlapRelayOption o) => new()
    {
        Id = o.Id,
        Name = o.Name,
    ...
    private static void UpdateEntry(RelayEntry entry, CatFlapRelayOption o)
    {
        entry.Name = o.Name;
